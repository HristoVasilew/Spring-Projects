...
//        }
    ...
    public String registerConfirm(@Valid UserRegisterBindingModel userRegisterBindingModel
        ...
        boolean isNameExist = userService.existByName(userRegisterBindingModel.getUsername());
...
//            redirect with mess
    ...
    @PostMapping("/login")
    public String loginConfig(@Valid UserLoginBindingModel userLoginBindingModel
            , BindingResult bindingResult, RedirectAttributes redirectAttributes) {
